                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                        {filteredCertificates.map((certificate, index) => (
                            <div
                                key={certificate.id}
                                className="group bg-black/70 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 cursor-pointer transform hover:-translate-y-2"
                                style={{
                            ...
                            >
                                <div className="relative aspect-[3/4] overflow-hidden bg-black/50">
                                    {certificate.docUrl && certificate.docUrl.endsWith(".pdf") ? (
                                        <iframe
                                            src={certificate.docUrl}
                                            className="w-full h-[80vh] bg-black rounded-2xl border"
                                        />
                                    ) : (
                                        <Image
