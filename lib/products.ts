...
const img1 = "/product1 (1).jpg"
  export const products: any[] = [
    ...
    },
    {
      ...
      "use_Bangla": "টি.এস.আর সাদা কাপড়ের দাগ ওঠানোর জন্য ইহা অনেক কার্যকরী। ইহা প্যাডের কালি, স্পিল প্যাড, কাল দাগ এবং ধৌত অমসৃুতায় ব্যবহার্য। কয়েক ফোঁটা টি.এস.আর দাগের উপর ফেলুন, ব্রাশ দিয়ে ঘষুন এবং পানিতে ধুয়ে নিন। পুনরায় স্পট ভেনিশের সাহায্যে ঘষে বা কচলিয়ে ভালোভাবে পরিষ্কার পানিতে ধুয়ে নিন।",
      "Storage": "N/A",
    ...
    },
    {
      ...
      "use_Bangla": "দাগের উপর অল্প পরিমাণ পি.এস.আর নিন এরপর নরম ব্রাশ দ্বারা ঘষে স্পট ভ্যানিশ দিয়ে ধুয়ে ফেলুন। প্রিন্টের দাগ এবং ধৌত হওয়ার অপরিশ্রুত জন্য।",
      "Storage": "Keep in cool and dry place.",
      "Mfg_Date": "August 2025",
      "Exp_Date": "July 2026",
      "warning_English": "Do not use on any fabrics that can be damage by water or thinner. Rubber hand gloves, if necessary. Separately wash white & dyed/printed clothes.",
      "Warning_Bangla": "পানি ও থিনার যে কাপড়ে ব্যবহারযোগ্য নয়, সে কাপড়ে ব্যবহার করবেন না। প্রয়োজনে, হ্যান্ড গ্লাভস ব্যবহার করুন। সাদা ও রঙিন কাপড় আলাদাভাবে ধুয়ে নিন। ব্যবহারে সর্বদা সতর্ক থাকুন।"
    },
    {
      "id": 13,
      "Product_Name": "See WATER (সি ওয়াটার)",
      "image": "/images/pro13.jpg",
      "badge": "/images/b13.png",
